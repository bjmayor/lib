...
/**
 * Store an image into memory and disk cache at the given key immediately.
 *
 ...
 *
 * @param keyArray The unique images cache key
 */
...
/**
 * Remove the images from memory and optionaly disk cache synchronousely
 *
 * @param keyArray The unique images cache key
 * @param fromDisk Also remove cache entry from disk if YES
 */
